...
export default function Header() {
  ...
  return (
    <Navbar className='border-b-2'>
      <Link
        to='/'
        className='self-center whitespace-nowrap text-2xl sm:text-3xl font-bold text-gray-800 dark:text-black transition duration-100 ease-in-out hover:text-red-400'
        style={{ fontFamily: 'cursive' }}
      >
        <img src="./logo.png" alt="Logo" className="h-8 w-8 mr-4" /> {/* Adjust the size and margin as needed */}
        VerseValley
      </Link>
